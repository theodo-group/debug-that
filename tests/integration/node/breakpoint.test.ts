...
describe("Breakpoint integration", () => {
	test("set breakpoint by file:line", () =>
		withPausedSession("test-bp-set", "tests/fixtures/js/simple-app.js", async (session) => {
			const result = await session.setBreakpoint("tests/fixtures/js/simple-app.js", 5);
	...
	test("list breakpoints returns set breakpoints", () =>
		withPausedSession("test-bp-list", "tests/fixtures/js/simple-app.js", async (session) => {
	...
	test("remove breakpoint", () =>
		withPausedSession("test-bp-rm", "tests/fixtures/js/simple-app.js", async (session) => {
			const result = await session.setBreakpoint("tests/fixtures/js/simple-app.js", 5);
	...
	test("remove all breakpoints", () =>
		withPausedSession("test-bp-rm-all", "tests/fixtures/js/simple-app.js", async (session) => {
			await session.setBreakpoint("tests/fixtures/js/simple-app.js", 5);
			await session.setBreakpoint("tests/fixtures/js/simple-app.js", 11);
	...
	test("set conditional breakpoint", () =>
		withPausedSession("test-bp-cond", "tests/fixtures/js/simple-app.js", async (session) => {
			await session.setBreakpoint("tests/fixtures/js/simple-app.js", 5, {
	...
	test("set breakpoint with hit count", () =>
		withPausedSession("test-bp-hit", "tests/fixtures/js/simple-app.js", async (session) => {
			await session.setBreakpoint("tests/fixtures/js/simple-app.js", 5, { hitCount: 3 });
			const list = session.listBreakpoints();
			expect(list.length).toBe(1);
	...
	test("set exception pause mode", () =>
		withPausedSession("test-bp-catch", "tests/fixtures/js/simple-app.js", async (session) => {
	...
	test("set logpoint", () =>
		withPausedSession("test-lp-set", "tests/fixtures/js/simple-app.js", async (session) => {
	...
	test("mixed breakpoints and logpoints in list", () =>
		withPausedSession("test-bp-lp-mix", "tests/fixtures/js/simple-app.js", async (session) => {
			await session.setBreakpoint("tests/fixtures/js/simple-app.js", 5);
			await session.setLogpoint("tests/fixtures/js/simple-app.js", 11, '"add called"');
			await session.setBreakpoint("tests/fixtures/js/simple-app.js", 38);
	...
	test("remove unknown ref throws error", () =>
		withPausedSession("test-bp-rm-unknown", "tests/fixtures/js/simple-app.js", async (session) => {
